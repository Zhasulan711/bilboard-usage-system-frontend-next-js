...
export const Graphs = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#0F1623] w-[1004px] h-[600px] rounded-lg pl-[15px] pt-[14px] flex flex-col space-y-[3px] relative">
      ...
      <h3 className="text-sm font-normal text-[#D9D9D9] dark:text-[#575C65]">
      ...
      <div className="flex flex-row space-x-[10px]">
        {navBars.map((items, index) => (
          <div
            className="bg-[#D9D9D9] dark:bg-[#070F1B] w-[113px] h-9 text-xl font-normal text-black dark:text-white flex justify-center items-center"
            key={index}
          >
            {" "}
            {items}{" "}
